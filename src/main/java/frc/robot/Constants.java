...
final class Constants {
    ...
    static final class DrvConst {
         ...
         static final double kMaxAngularSpeed = 2*Math.PI; // 0.5 rotation per second, was 0.5 rad/s before
         ...
         /**  each {@link DrvConst.Setup#absOffset} is 1/4 circle rotated from the adjacent one.*/
    ...
    static final class SwvModConst {
        ...
        static final double kWheelRadius = Units.inchesToMeters(2.4)/2; // 2.4 assumes the wheel has been compressed.
        //wheel specs https://plummerindustries.com/robotics/resources/drive-corner-info
